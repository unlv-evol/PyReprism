...
try:
    ...
    # Support alternate casing that occurs in some import paths
    from PyReprism.utils import extension  # type: ignore
...
class Stylus(BaseLanguage):
    """Stylus language helper."""
